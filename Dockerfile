...
COPY --chown=nextjs:nodejs --from=builder /app/prisma/schema.prisma ./prisma/schema.prisma
COPY --chown=nextjs:nodejs --from=builder /app/prisma/migrations ./prisma/migrations
COPY --chown=nextjs:nodejs --from=builder /app/prisma/seed-production.ts ./prisma/seed-production.ts
