...
export function dashboardMetricCards(metrics: DashboardMetrics) {
  return [
    ...
    { title: "Объекты без дизайнера", value: metrics.objectsWithoutDesigner, icon: AlertTriangle, variant: "outline" as const },
    { title: "Объекты без участников", value: metrics.objectsWithoutParticipants, icon: AlertTriangle, variant: "outline" as const },
